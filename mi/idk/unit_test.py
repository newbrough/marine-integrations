    ...
    def __exit__(self,exc_type, exc_value, tb):
        ...
        if not issubclass(exc_type, self.expected):
            if issubclass(exc_type, IonException) and issubclass(self.expected, InstrumentException):
                return exc_type.status_code == self.expected.error_code
...
#        out = super(InstrumentDriverIntegrationTestCase,self).assertRaises(excClass, callableObj=callableObj, *args, **kwargs)
#        print 'before change: %r' % out.__exit__
#        out.__exit__ = self.__eggzit__
#        print 'after change: %r' % out.__exit__
#        return out
